...
module h5.application {
    ...
    export class OdinMIService implements IOdinMIService {
        ...
        public callWebService(program: string, transaction: string, requestData: any, maxReturnedRecords = 100, company?: string, division?: string): ng.IPromise<M3.IMIResponse> {
