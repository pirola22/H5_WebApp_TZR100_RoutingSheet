...
module h5.application {
    ...
    export interface IAppService {
        ...
        addFieldValue(VHMFNO: string, RoutingSheetNo: string, SeqNo: string, VHWHLO: string,
        ...
        DeleteFieldValue(VHMFNO: string, RoutingSheetNo: string, SeqNo: string, VHWHLO: string ): ng.IPromise<M3.IMIResponse>;
    ...
    export class AppService implements IAppService {
        ...
        public addFieldValue(VHMFNO: string, RoutingSheetNo: string, SeqNo: string, VHWHLO: string,
        ...
        public DeleteFieldValue(VHMFNO: string, RoutingSheetNo: string, SeqNo: string, VHWHLO: string ) {
            let requestData = {
                FILE: "MWOHED",
                PK01: VHMFNO,
                PK02: RoutingSheetNo,
